...
//            Assert.assertEquals("Parent of raster layer 1 after drag and drop operation", idUserRootFolderA, raster1.getFolder().getId());
//
//            vector1 = geoPlatformService.getVectorLayer(idVector1);
...
//            Assert.assertEquals("Parent of raster layer 2 after drag and drop operation", idUserRootFolderB, raster2.getFolder().getId());
//
//            vector2 = geoPlatformService.getVectorLayer(idVector2);
//            Assert.assertEquals("Position of vector layer 2 after drag and drop operation", 2, vector2.getPosition());
//            Assert.assertEquals("Parent of vector layer 2 after drag and drop operation", idUserRootFolderB, vector2.getFolder().getId());
//
...
//            checkDD = geoPlatformService.saveDragAndDropLayerAndTreeModifications(
//                    super.usernameTest, idRaster2, idUserRootFolderB, 2, descendantsMapData);
...
//            Assert.assertEquals("Parent of vector layer 2 after drag and drop operation", idUserRootFolderA, vector2.getFolder().getId());
//
//            map.clear();
...
//            checkDD = geoPlatformService.saveDragAndDropLayerAndTreeModifications(
//                    super.usernameTest, idVector1, idUserRootFolderA, 4, descendantsMapData);
...
//        Assert.assertEquals("Parent of raster layer 1 after DD II", idUserRootFolderA, raster1.getFolder().getId());
//
//        vector1 = geoPlatformService.getVectorLayer(idVector1);
...
//        Assert.assertEquals("Parent of raster layer 2 after DD II", idUserRootFolderB, raster2.getFolder().getId());
//
//        vector2 = geoPlatformService.getVectorLayer(idVector2);
//        Assert.assertEquals("Position of vector layer 2 after DD II", 1, vector2.getPosition());
//        Assert.assertEquals("Parent of vector layer 2 after DD II", idUserRootFolderB, vector2.getFolder().getId());
//    }
