...
public class WSFolderTest extends ServiceTest {
    ...
    public void testUpdateFolder() {
        ...
        try {
            ...
            Assert.assertEquals("Parent ID of FolderUpdated NOT match", idRootFolderA, folderUpdated.getParent().getId());
    ...
    public void testDeleteFolder() {
        try {
            ...
            int totalFolders = gpWSClient.getProjectDetail(idProjectTest).getNumberOfElements();
...
//                    totalFolders - 4, gpWSClient.getProjectDetail(idProjectTest).getNumberOfElements());
    ...
    public void testDragAndDropFromRootToTop() {
        ...
        try {
            ...
            Assert.assertEquals("Parent of root folder B after DD I from root to top", idRootFolderA, rootFolderB.getParent().getId());
    ...
    public void testDragAndDropFromRootToBottom() {
        ...
        try {
            ...
            Assert.assertEquals("Parent of root folder A after DD I from root to bottom", idRootFolderB, rootFolderA.getParent().getId());
